    ...
    const rollDice = () => {
        if (!roundOver) {
            ...
            if (sum === cardValue1Number + cardValue2Number) {
                ...
                setCoins(newBalance);
                setPayoutMultiplier(
                    parseFloat((payoutMultiplier + 0.1).toFixed(1))
                );
        ...
        <ThemeProvider theme={theme}>
            ...
            <CustomPaper className={descriptionCollapsed ? 'd-none' : ''}>
                <Typography variant='body1'>
                    ...
                    <ul>
                        <li>
                            If the sum of the dice rolls equals the combined
                            value of the two drawn cards, you win{' '}
                            <span className='fw-bold bg-warning'>5x</span> your
                            bet.
                        </li>
                        <li>
                            If you tie with the cards, you get your bet back.
                            Multiplier goes up by{' '}
                            <span className='fw-bold bg-warning'>0.1x</span> on
                            a tie.
                        </li>

                        <li>
                            If the sum of the dice rolls falls between the
                            values of the two cards you drew, you win based on
                            the payout multiplier. Multiplier goes up by{' '}
                            <span className='fw-bold bg-warning'>0.3x</span> on
                            a win.
                        </li>
